  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[500px] md:min-h-[670px] bg-surface-dark flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-50 bg-surface-dark bg-no-repeat bg-center bg-cover"></div>
        <img
          src="/hero-bg.png"
          alt=""
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 opacity-80 bg-surface-dark bg-no-repeat bg-center bg-cover"></div>
            ...
            <div className="flex flex-row md:flex-wrap items-center gap-2 md:gap-3.5 overflow-x-auto md:overflow-visible w-full md:w-auto px-4 md:px-0 justify-start md:justify-center pb-4 md:pb-0 snap-x [direction:ltr] md:[direction:rtl]">
              {[
                ...
                >
                  ...
                  <span
                    className={`text-sm md:text-lg font-extrabold leading-6 ${activeService === service.id
                      ? "text-white"
          ...
          <div className="flex flex-col items-center gap-7 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3.5">
              <button
                ...
                className={`flex h-[52px] px-4 justify-center items-center gap-2.5 rounded-lg transition-all ${activeAppTab === "providers"
                  ? "bg-primary-blue"
                  : "bg-primary-blue/8"
                  }`}
              >
                <span
                  className={`text-lg font-extrabold leading-6 ${activeAppTab === "providers" ? "text-white" : "text-white opacity-80"
                    }`}
                >
              ...
              <button
                ...
                className={`flex h-[52px] px-4 justify-center items-center gap-2.5 rounded-lg transition-all ${activeAppTab === "companies"
                  ? "bg-primary-blue"
                  : "bg-primary-blue/8"
                  }`}
              >
                <span
                  className={`text-lg font-extrabold leading-6 ${activeAppTab === "companies" ? "text-white" : "text-white opacity-80"
                    }`}
                >
                  بترولايف للشركات
                </span>
              ...
              <button
                ...
                className={`flex h-[52px] px-4 justify-center items-center gap-2.5 rounded-lg transition-all ${activeAppTab === "individuals"
                  ? "bg-primary-blue"
                  : "bg-primary-blue/8"
                  }`}
              >
                <span
                  className={`text-lg font-extrabold leading-6 ${activeAppTab === "individuals" ? "text-white" : "text-white opacity-80"
                    }`}
                >
                  بترولايف للأفراد
                </span>
